function Export-IntuneHtmlReport {
    ...
    .EXAMPLE
        Export-IntuneHtmlReport -Path PSGRAPHIT.html -Show
    ...
    New-HTML -TitleText 'PSGRAPHIT — Intune Assignments' -FilePath $Path -ShowHTML:$Show {
        New-HTMLHeader {
            New-HTMLText -Text 'PSGRAPHIT — Microsoft Intune & Entra management' -FontSize 26 -FontWeight bold -Color '#1f9d8f'
        }
