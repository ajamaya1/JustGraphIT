function Export-IntuneHtmlReport {
    ...
    .EXAMPLE
        Export-IntuneHtmlReport -Path GRAPHITE.html -Show
    ...
    New-HTML -TitleText 'GRAPHITE — Intune Assignments' -FilePath $Path -ShowHTML:$Show {
        New-HTMLHeader {
            New-HTMLText -Text 'GRAPHITE — Microsoft Intune & Entra management' -FontSize 26 -FontWeight bold -Color '#1f9d8f'
        }
